...
static ::_pb::Metadata file_level_metadata_flwr_2fproto_2fnode_2eproto[1];
...
const ::_pbi::DescriptorTable descriptor_table_flwr_2fproto_2fnode_2eproto = {
    false, false, 87, descriptor_table_protodef_flwr_2fproto_2fnode_2eproto,
...
uint8_t* Node::_InternalSerialize(
  ...
  if (this->_internal_anonymous() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_anonymous(), target);
  }

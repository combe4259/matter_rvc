...
PROTOBUF_CONSTEXPR Parameters::Parameters(
    ::_pbi::ConstantInitialized)
  : tensors_()
  , tensor_type_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}

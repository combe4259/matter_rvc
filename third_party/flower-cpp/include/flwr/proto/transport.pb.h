...
void Parameters::set_tensor_type(ArgT0&& arg0, ArgT... args) {
 ...
 tensor_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Parameters::set_allocated_tensor_type(std::string* tensor_type) {
  ...
  tensor_type_.SetAllocated(tensor_type, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (tensor_type_.IsDefault()) {
    tensor_type_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void Scalar::set_string(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_string()) {
    clear_scalar();
    set_has_string();
    scalar_.string_.InitDefault();
  }
  scalar_.string_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Scalar::_internal_set_string(const std::string& value) {
  ...
  scalar_.string_.Set(value, GetArenaForAllocation());
}
...
inline void Scalar::set_allocated_string(std::string* string) {
  ...
  if (string != nullptr) {
    set_has_string();
    scalar_.string_.InitAllocated(string, GetArenaForAllocation());
  }
...
inline void Scalar::set_bytes(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_bytes()) {
    clear_scalar();
    set_has_bytes();
    scalar_.bytes_.InitDefault();
  }
  scalar_.bytes_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Scalar::_internal_set_bytes(const std::string& value) {
  ...
  scalar_.bytes_.Set(value, GetArenaForAllocation());
}
...
inline void Scalar::set_allocated_bytes(std::string* bytes) {
  ...
  if (bytes != nullptr) {
    set_has_bytes();
    scalar_.bytes_.InitAllocated(bytes, GetArenaForAllocation());
  }

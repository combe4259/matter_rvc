...
class Task final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::flwr::proto::Node* release_producer();
  ...
  PROTOBUF_NODISCARD ::flwr::proto::Node* release_consumer();
  ...
  PROTOBUF_NODISCARD ::flwr::proto::RecordSet* release_recordset();
...
class TaskIns final :
 ...
 public:
  ...
  ~TaskIns() override;
  explicit PROTOBUF_CONSTEXPR TaskIns(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TaskIns* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::flwr::proto::Task* release_task();
...
class TaskRes final :
 ...
 public:
  ...
  ~TaskRes() override;
  explicit PROTOBUF_CONSTEXPR TaskRes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TaskRes* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void Task::set_delivered_at(ArgT0&& arg0, ArgT... args) {
 ...
 delivered_at_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Task::set_allocated_delivered_at(std::string* delivered_at) {
  ...
  delivered_at_.SetAllocated(delivered_at, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (delivered_at_.IsDefault()) {
...
inline uint64_t TaskIns::_internal_run_id() const {
  return run_id_;
}
inline uint64_t TaskIns::run_id() const {
  // @@protoc_insertion_point(field_get:flwr.proto.TaskIns.run_id)
  return _internal_run_id();
}
inline void TaskIns::_internal_set_run_id(uint64_t value) {
  
  run_id_ = value;
}
inline void TaskIns::set_run_id(uint64_t value) {
...
inline uint64_t TaskRes::_internal_run_id() const {
  return run_id_;
}
inline uint64_t TaskRes::run_id() const {
  // @@protoc_insertion_point(field_get:flwr.proto.TaskRes.run_id)
  return _internal_run_id();
}
inline void TaskRes::_internal_set_run_id(uint64_t value) {
  
  run_id_ = value;
}
inline void TaskRes::set_run_id(uint64_t value) {
  _internal_set_run_id(value);

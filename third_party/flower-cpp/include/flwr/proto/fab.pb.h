...
void Fab::set_hash_str(ArgT0&& arg0, ArgT... args) {
 ...
 hash_str_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Fab::set_allocated_hash_str(std::string* hash_str) {
  ...
  hash_str_.SetAllocated(hash_str, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (hash_str_.IsDefault()) {
